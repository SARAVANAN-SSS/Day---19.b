...
<div class="col-md-4" id="div1">
    ...
    <label for="Fname" class="col-3 col-sm-3">First Name<sup style="color:red">*</sup></label>
     <input type="text" class="col-8 col-md-10 col-sm-7" id="Fname" placeholder="First name" required ><br><br>
     <label for="Lname" class="col-3 col-sm-3">Last Name<sup style="color:red">*</sup></label>
     <input type="text" class="col-8 col-md-10 col-sm-7" id="Lname" placeholder="Last name" required ><br><br>
     <label for="address1" class="col-3 col-sm-3">Address line-1<sup style="color:red">*</sup></label>
     <input type="text" class="col-8 col-md-10 col-sm-7" id="address1" placeholder="Address line.1" required ><br><br>
     <label for="address2" class="col-3 col-sm-3">Address line-2<sup style="color:red">*</sup></label>
     <input type="text" class="col-8 col-md-10 col-sm-7" id="address2" placeholder="Address line.2" required ><br><br>
     <label for="pinCode" class="col-3 col-sm-3">Pin-code<sup style="color:red">*</sup></label>
     <input type="number" class="col-8 col-md-10 col-sm-7" id="pinCode" placeholder="Pin code" required ><br><br>
     ...
     <label class="col-4 col-sm-3">Choice of Food<sup style="color:red">*</sup></label>
     ...
     <ul class="col-8 col-md-10 col-sm-7" style="list-style:none;margin-left: 15%%;">
        <li><input class="check" id="cb1" onclick="check()" type="checkbox" value="Chicken"/><label for="cd1"> Chicken </label></li><br>
        <li><input class="check" id="cb2" onclick="check()" type="checkbox" value="Mutton"/><label for="cd2"> Mutton </label></li><br>
        <li><input class="check" id="cb3" onclick="check()" type="checkbox" value="Fish"/><label for="cd3"> Fish </label></li><br>
        <li><input class="check" id="cb4" onclick="check()" type="checkbox" value="Beacon"/><label for="cd4"> Beacon </label></li><br>
        <li><input class="check" id="cb5" onclick="check()" type="checkbox" value="Prawn"/><label for="cd5"> Prawn </label></li><br>
     </ul>
     ...
     <input type="button" class="btn" value="Add" id="btn" onclick="addRow()"/><br><br>
    </div>
...
<h2>Table<h2><hr>
    ...
    <input class="btn" id="reset" onclick="reset1()" value="Reset" disabled/>
</div>
</div>
</div>`
